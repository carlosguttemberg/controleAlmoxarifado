...
@injectable()
class GraphicCategoriesCalibrationService {
  constructor(
  ...
  public async execute({
    ...
    const calibration = await this.calibrationsRepository.generateGraphicTypes({
      calibrationType_id,
      employee_id,
      equipament_id,
      status,
...
export default GraphicCategoriesCalibrationService;
