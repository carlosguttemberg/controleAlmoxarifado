...
const CheckListMaintenance: React.FC = () => {
  ...
  const handleSubmit = useCallback(
    async (data: CheckListMaintenanceFormData) => {
      try {
        ...
        await api.post('/checkListMaintenance', data);
      ...
      <Content>
        <AnimationContainer>
          <Form ref={formRef} onSubmit={handleSubmit}>
            <h1>Cadastro de CheckList de Manutenção</h1>
          ...
          <Link to="/listCheckListMaintenance">
            <FiArrowLeft />
            Voltar
          </Link>
        </AnimationContainer>
